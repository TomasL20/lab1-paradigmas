...
(define (scene>string scene)
  (define (generarString scene fila columna string)
    (cond
      ...
      [(comparar (cons fila columna) (car (getProjectiles scene))) (generarString scene fila (+ columna 1) (string-append string "P"))]
      [(comparar (cons fila columna) (cdr (getProjectiles scene))) (generarString scene fila (+ columna 1) (string-append string "M"))]
...
;TDA
;personaje
(define PJ1 (personaje 3 4 0 100 "A"))
(define PJ2 (personaje 28 40 1 100 "E"))
(define PJ3 (personaje 15 2 0 100 "A"))
;TDA
;proyectil
(define M1 (proyectil 15 40 20 40 20))
(define M2 (proyectil 30 70 15 20 15))
(define M3 (proyectil 28 26 60 10 9))
;TDA
;createScene
(define S1 (createScene 100 100 5 2 748357483))
(define S2 (createScene 70 80 8 2 748357483))
(define S3 (createScene 45 100 3 2 748357483))
;checkScene
(define CS1 (checkScene S1))
(define CS2 (checkScene S2))
(define CS3 (checkScene S3))
;scene>string
(define SS1 (scene>string S1))
(define SS2 (scene>string S2))
(define SS3 (scene>string S3))
;play
(define P1 ((((((play S1) 2) 1) tf) 30) 748357483))
(define P2 ((((((play S2) 5) 3) tf) 15) 748357483))
(define P3 ((((((play S3) 1) 2) tf) 40) 748357483))
;playLazy
(define PL1 (playLazy S1 2 1 tf 1 30 748357483))
(define PL2 (playLazy S2 5 3 tf 5 15 748357483))
(define PL3 (playLazy S3 1 2 tf 2 40 748357483))